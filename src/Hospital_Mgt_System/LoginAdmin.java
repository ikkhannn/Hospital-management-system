...
String userName;
        ...
        getToolkit().beep();
        JOptionPane.showMessageDialog(null,"One or more fields are empty.","Login Error",JOptionPane.ERROR_MESSAGE);
        }
        else{
         if (m.find()){
          ...
          JOptionPane.showMessageDialog(null,"Password must start with an Alphabet.","Login Error",JOptionPane.ERROR_MESSAGE);
          }
        }// TODO add your handling code here:
    ...
    /**
     * @param Saad the command line arguments
     */
    public static void main(String Saad[]) {
